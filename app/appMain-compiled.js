...
function initTrayMenu() {
  ...
  return _electron.Menu.buildFromTemplate([{
    ...
    click: () => {
      return (0, _enableDisableBlueLoss.enableDisableBlueLoss)(toggledFromTray, !(0, _settings.getSettings)().blueLossEnabled);
    }
  }, {
    label: 'Quit BlueLoss',
...
function initSettingsIPClisteners() {
  ...
  _electron.ipcMain.on('renderer:blueloss-enabled-disabled', function (event, enabled) {
    (0, _enableDisableBlueLoss.enableDisableBlueLoss)(toggledFromTray, enabled);
  });
