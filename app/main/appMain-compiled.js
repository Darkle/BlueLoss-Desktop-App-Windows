...
function initScan() {
  ...
  generateHostIPs(gateway, hostsRangeStart, hostsRangeEnd).forEach(function (hostIP) {
    scanHost(hostIP, hostScanTimeout).then(getMacAdressForHostIP)
    // .then(getVendorInfoForMacAddress)
    .then(_handleScanResults.handleScanResults).catch(_logging.logger.error);
  });

  setTimeout(initScan, scanInterval);
} // http://bit.ly/2pzLeD3
...
const defaultGateway = __webpack_require__(/*! default-gateway */ "default-gateway");
const ipaddr = __webpack_require__(/*! ipaddr.js */ "./node_modules/ipaddr.js/lib/ipaddr.js");
